...
namespace Akaraliunas\AnimeEAV\Model\ResourceModel;
...
class Anime extends AbstractEntity
{
    ...
    public function __construct(
        ...
        $this->setType(AnimeSetup::ENTITY_TYPE_CODE);

        $this->setConnection(AnimeSetup::ENTITY_TYPE_CODE . '_read', AnimeSetup::ENTITY_TYPE_CODE . '_write');
