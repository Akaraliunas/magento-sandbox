...
namespace Akaraliunas\AnimeEAV\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'Akaraliunas_AnimeEAV';
    const KEY_IS_GLOBAL = 'is_global';
    const KEY_IS_STATIC = 'static';
    protected $_eventObject = 'attribute';
    protected static $_labels = null;
    protected $_eventPrefix = AnimeSetup::ENTITY_TYPE_CODE . '_attribute';
    protected function _construct()
    {
        $this->_init(\Akaraliunas\AnimeEAV\Model\ResourceModel\Attribute::class);
    }
