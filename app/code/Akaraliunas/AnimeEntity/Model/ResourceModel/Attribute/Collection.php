...
namespace Akaraliunas\AnimeEAV\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(AnimeSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(AnimeSetup::ENTITY_TYPE_CODE . '_eav_attribute')],
