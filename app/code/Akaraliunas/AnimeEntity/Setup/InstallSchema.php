...
use Akaraliunas\AnimeEAV\Setup\EavTablesSetupFactory;
use Akaraliunas\AnimeEAV\Setup\AnimeSetup;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    {
        $setup->startSetup();
        $tableName = AnimeSetup::ENTITY_TYPE_CODE;
        ...
        /** @var \Akaraliunas\AnimeEAV\Setup\EavTablesSetup $eavTablesSetup */
        $eavTablesSetup = $this->eavTablesSetupFactory->create(['setup' => $setup]);
        $eavTablesSetup->createEavTables(AnimeSetup::ENTITY_TYPE_CODE);
        $setup->endSetup();
    }
}
